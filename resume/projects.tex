...
%---------------------------------------------------------
	\cventry
		...
		{MyToDo (\textmd{\em\url{https://github.com/indocomsoft/cvwo-assignment-2017})}} % Name of Project
		{} % Location
...
\cventry
    ...
    {Wi-Fi Extender and Load-balancer (\textmd{\em \url{https://github.com/indocomsoft/Maker-Portfolio}})} % Name of Project
    {Singapore} % Location
