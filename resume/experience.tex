	...
	\cventry
		...
		{May 2018 - Aug 2018} % Date(s)
		{
			\begin{cvitems}
				...
				\item {Developed a Log Viewer app capable of handling 200k lines, extracting ZIP files, syntax highlighting, regex search and filter, and is integrated with the debugging menu of my team's product.}
